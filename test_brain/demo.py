...
if __name__ == "__main__":
    ...
    snapshot = '/scratch1/hedongzh/brainseg/model/T1_SkullScalp_t1256/TU_R50-ViT-B_16_skip3_30k_epo150_bs16_256_' + args.loss + '_beta_' + str(args.beta)
    if args.warmup > 0:
    ...
    test_data_file = '/scratch/hedongzh/brainseg/test_t1.h5'
    output_file = '/scratch1/hedongzh/brainseg/test_t1_output_BCE' + str(args.beta) + args.suffix
