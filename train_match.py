...
from trainer_match import trainer_synapse
...
if __name__ == "__main__":
    ...
    snapshot_path = "./model/{}/{}/{}".format(args.exp, 'TU', 'Match')
    ...
    if args.resume:
        net.load_state_dict(torch.load(
            snapshot_path + '/epoch_' + str(args.resume) + '.pth'))
