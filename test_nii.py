...
if __name__ == "__main__":
    ...
    snapshot = '/scratch1/hedongzh/brainseg/model/T1_SkullScalp_t1256/TU/Match_R50-ViT-B_16_skip3_30k_epo150_bs8_256_BCE_beta_0.01/epoch_0.pth'
    # snapshot = '/home1/ajoshi/epoch_10.pth'
    

    # snapshot = '/scratch1/hedongzh/brainseg/model/T1T2_SkullScalp_t1t2_styleaug256/TU_R50-ViT-B_16_skip3_30k_epo150_bs16_256/epoch_34.pth'

    # input_nii = '/project/ajoshi_27/headreco_out/m2m_sub-CC110033/T1fs_conform.nii.gz'
    input_nii = '/scratch1/hedongzh/brainseg/T1fs_conform_low_field.nii.gz'
    output_file = 'm2m_sub-CC110033_robust_t1t2_match_0_yz.label.nii.gz'
